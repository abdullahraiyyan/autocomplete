...
#if __ANDROID__
using XAutoSuggestBoxSuggestionChosenEventArgs = autocomplete.Helper.AutoSuggestBoxSuggestionChosenEventArgs;
using XAutoSuggestBoxTextChangedEventArgs = autocomplete.Helper.AutoSuggestBoxTextChangedEventArgs;
using XAutoSuggestBoxQuerySubmittedEventArgs = autocomplete.Helper.AutoSuggestBoxQuerySubmittedEventArgs;
using NativeAutoSuggestBox = autocomplete.Platforms.Android.Control.NativeAutoSuggestBox;
#elif __IOS__
using UIKit;
using XAutoSuggestBoxSuggestionChosenEventArgs = autocomplete.Helper.AutoSuggestBoxSuggestionChosenEventArgs;
using XAutoSuggestBoxTextChangedEventArgs = autocomplete.Helper.AutoSuggestBoxTextChangedEventArgs;
...
#if MACCATALYST
using NativeAutoSuggestBox = autocomplete.Platforms.MacCatalyst.Control.NativeAutoSuggestBox;
#elif IOS
using NativeAutoSuggestBox = autocomplete.Platforms.iOS.Control.NativeAutoSuggestBox;
#endif
...
namespace autocomplete.Handler
{
    /// <summary>
