...
namespace autocomplete.Platforms.Android.Control
{
    /// <summary>
    ...
    /// </summary>
    public partial class NativeAutoSuggestBox : AutoCompleteTextView
    {
        ...
        public override bool EnoughToFilter()
        {
            ...
            // Overriding this method to always returns true changes this behavior.
            return true;
        }
